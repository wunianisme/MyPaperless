...
/**
 * 自定義帶清除按鈕的AutoCompleteTextView
 *@ClassName ClearAutoCompleteTextView
 *@Author wunian
 *@Date 2017/10/23 下午2:46:00
 */
public class ClearAutoCompleteTextView extends AutoCompleteTextView implements OnFocusChangeListener,TextWatcher{
