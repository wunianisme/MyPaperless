...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.imageedit_righttop);
        mResizeDrawableDiagonal2 = resources.getDrawable(R.drawable.imageedit_lefttop);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                mOutlinePaint.setColor(0xFF57C202);
            }
