...
public class EditImage {
	...
	public EditImage(Context context, EditImageView imageView,Handler handler)
	{
		mContext = context;
...
//                mRunFaceDetection.run();
    ...
    public String saveToLocal(Bitmap bm,String dirPath,String imgFileName)
    {

		File dir =FileUtil.createLocalDir(dirPath);
		File f = new File(dir, imgFileName+ ".png");
...
//    		mProgress.show();
    	...
    	public void run()
    	{
    		...
    		mHandler.post(new Runnable() {
                public void run() {
                    try{
                    	mHandler.sendMessage(mHandler.obtainMessage(EditImageActivity.SHOW_PROGRESS));
...
//    					}
    		...
    		{
    			mHandler.sendMessage(mHandler.obtainMessage(EditImageActivity.REMOVE_PROGRESS));
